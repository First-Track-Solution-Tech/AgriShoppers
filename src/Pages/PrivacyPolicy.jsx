      ...
      <div className="bg-gradient-to-b from-cream-100 via-white to-olive-50 min-h-screen">
        ...
        <section className="max-w-6xl mx-auto px-4 py-16">
          <div className="grid md:grid-cols-4 gap-6">
            ...
            <div className="bg-white p-6 rounded-2xl shadow-lg text-center">
              <Lock className="mx-auto text-wheat-600 mb-4" size={40} />
              <h3 className="font-bold text-olive-800">Secure Data</h3>
            </div>

            <div className="bg-white p-6 rounded-2xl shadow-lg text-center">
              <Database className="mx-auto text-wheat-600 mb-4" size={40} />
              <h3 className="font-bold text-olive-800">Protected Storage</h3>
            </div>

            <div className="bg-white p-6 rounded-2xl shadow-lg text-center">
              <UserCheck className="mx-auto text-wheat-600 mb-4" size={40} />
              <h3 className="font-bold text-olive-800">User Privacy</h3>
            </div>

            <div className="bg-white p-6 rounded-2xl shadow-lg text-center">
              <Shield className="mx-auto text-wheat-600 mb-4" size={40} />
              <h3 className="font-bold text-olive-800">Trusted Platform</h3>
            </div>
        ...
        <section className="max-w-5xl mx-auto px-4 pb-20">
          ...
          <div className="bg-white rounded-3xl shadow-xl p-10 text-center">
            ...
            <Mail className="mx-auto text-wheat-600 mb-4" size={50} />
