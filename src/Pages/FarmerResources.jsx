      ...
      <div className="bg-gradient-to-b from-green-50 via-white to-green-100 min-h-screen">
        ...
        <section className="relative overflow-hidden py-20">
          <div className="max-w-7xl mx-auto px-4 text-center">
            ...
            <span className="bg-green-100 text-green-700 px-5 py-2 rounded-full text-sm font-semibold shadow">
              🌱 Smart Farming Solutions
            </span>

            <h1 className="mt-6 text-5xl md:text-6xl font-extrabold text-green-800 leading-tight">
              Farmer Resources
            </h1>
            ...
            <button className="mt-8 bg-green-700 hover:bg-green-800 text-white px-8 py-4 rounded-full font-semibold flex items-center gap-3 mx-auto transition duration-300 shadow-lg">
              Explore Resources
              <FaArrowRight />
            </button>
          </div>
        ...
        <section className="max-w-7xl mx-auto px-4 pb-20">
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            {resources.map((item, index) => (
              <div
                key={index}
                className="bg-white rounded-3xl p-8 shadow-lg hover:shadow-2xl hover:-translate-y-2 transition-all duration-300 border border-green-100"
              >
                <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-green-100 to-green-200 text-green-700 flex items-center justify-center text-3xl mb-6 shadow">
                  {item.icon}
                </div>
        ...
        <section className="max-w-7xl mx-auto px-4 pb-20">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <h2 className="text-4xl font-extrabold text-green-800 mt-4 mb-6">
        ...
        <section className="px-4 pb-20">
          <div className="max-w-6xl mx-auto bg-gradient-to-r from-green-700 to-green-600 rounded-[40px] p-10 md:p-16 text-center text-white shadow-2xl">
            ...
            <button className="bg-white text-green-700 hover:bg-green-100 px-10 py-4 rounded-full font-bold text-lg transition duration-300 shadow-lg">
              Start Exploring
            </button>
